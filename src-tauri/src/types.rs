...
pub fn builtin_models() -> Vec<ModelDef> {
    vec![
        ...
        ModelDef { slug: "glm-5.2".into(),              display_name: "GLM-5.2".into(),              provider: "glm".into(),      enabled: true,  context_window: 131_072,   max_output_tokens: 16_384,  priority: 200,  default_reasoning_level: "high".into(),   input_price_per_1k: 0.0014, output_price_per_1k: 0.0014, ..Default::default() },
        ...
        ModelDef { slug: "claude-opus-4-5".into(),      display_name: "Claude Opus 4.5".into(),      provider: "anthropic".into(),  enabled: true,  context_window: 200_000,   max_output_tokens: 32_768,  priority: 50,   default_reasoning_level: "xhigh".into(),  input_price_per_1k: 0.015,  output_price_per_1k: 0.075,  ..Default::default() },
        ModelDef { slug: "gpt-5.1-codex".into(),        display_name: "GPT-5.1 Codex".into(),        provider: "openai".into(),     enabled: true,  context_window: 1_000_000, max_output_tokens: 128_000, priority: 60,   default_reasoning_level: "xhigh".into(),  input_price_per_1k: 0.00125,output_price_per_1k: 0.01,   ..Default::default() },
    ]
}
